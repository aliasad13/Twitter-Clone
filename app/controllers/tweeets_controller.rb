class TweeetsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tweeet.save
        format.html do  redirect_to root_path, notice: "Tweeet was successfully created."
        end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tweeets_url(@tweeet), notice: "Tweeet was successfully destroyed." }
